//
//  SHInternshipsFavoritesTableViewController.m
//  Topent
//
...
@interface SHInternshipsFavoritesTableViewController ()

@property (retain, nonatomic) NSString *favoritesKey;

@end

@implementation SHInternshipsFavoritesTableViewController
...
- (void)viewDidLoad
{
    ...
    _favoritesKey = @"internshipsFavorites";
...
{
    static NSString *CellIdentifier = @"internshipsFavoritesCell";
